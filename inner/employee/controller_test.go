...
func TestController_GetEmployee(t *testing.T) {
	...
	t.Run("should return employee", func(t *testing.T) {
		...
		// Готовим тестовое окружение
		req := httptest.NewRequest(fiber.MethodGet, "/api/v1/employees/123", nil)
		req.Header.Set("Content-Type", "application/json")
	...
	t.Run("should return err bad id", func(t *testing.T) {
		...
		// Готовим тестовое окружение
		req := httptest.NewRequest(fiber.MethodGet, "/api/v1/employees/bad", nil)
		req.Header.Set("Content-Type", "application/json")
...
func TestController_GetEmployeeByIds(t *testing.T) {
	...
	t.Run("should success get all employees by ids", func(t *testing.T) {
		...
		req := httptest.NewRequest(fiber.MethodPost, "/api/v1/employees/ids", body)
		req.Header.Set("Content-Type", "application/json")
...
func TestController_DeleteEmployee(t *testing.T) {
	...
	t.Run("should success del by id", func(t *testing.T) {
		...
		// Готовим тестовое окружение
		req := httptest.NewRequest(fiber.MethodDelete, "/api/v1/employees/123", nil)
		req.Header.Set("Content-Type", "application/json")
	...
	t.Run("should success err invalid id", func(t *testing.T) {
		...
		// Готовим тестовое окружение
		req := httptest.NewRequest(fiber.MethodDelete, "/api/v1/employees/badId", nil)
		req.Header.Set("Content-Type", "application/json")
...
func TestController_DeleteEmployeesByIds(t *testing.T) {
	...
	t.Run("should success del by ids", func(t *testing.T) {
		...
		// Готовим тестовое окружение
		body := strings.NewReader("{\"ids\": [123,124]}")
		req := httptest.NewRequest(fiber.MethodDelete, "/api/v1/employees/ids", body)
		req.Header.Set("Content-Type", "application/json")
